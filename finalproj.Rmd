...
```{r, include=FALSE}
library(dplyr)
listings <- read_csv(file = "data/listings.csv") %>% select(id,host_id, host_is_superhost, neighbourhood_cleansed, neighbourhood_group_cleansed, latitude, longitude, room_type, bedrooms, price, reviews_per_month, review_scores_rating, review_scores_location, availability_365)
```
...
```{r cars}
library(readr)
data <- read_csv(file = "data/listings.csv")
dataset<-read_csv(file = "data/listings.csv")
str(data)
library(tidyverse)
library(ggplot2)
library(GGally)
